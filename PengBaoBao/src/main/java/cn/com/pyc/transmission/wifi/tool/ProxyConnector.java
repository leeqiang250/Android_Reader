...
public class ProxyConnector extends Thread {
	...
	public Socket dataPortConnect(InetAddress clientAddr, int clientPort) {
		 ...
		 * transfer some data in PORT mode (not PASV mode). We xml_btn_send a
	...
	/**
	 * Given a socket returned from pasvListen(), xml_btn_send a data_pasv_accept request
