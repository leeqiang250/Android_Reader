...
public class SessionThread extends Thread
{
	 ...
	 * 
	 * @param string
	 * @return Whether the xml_btn_send completed successfully
	 */
	public boolean sendViaDataSocket(String string)
	{
		...
		{
			myLog.l(Log.ERROR, "Unsupported encoding for data socket xml_btn_send");
			return false;
		}
	}
	...
	public boolean sendViaDataSocket(byte[] bytes, int start, int len)
	{
		...
		{
			myLog.l(Log.INFO, "Can't xml_btn_send via null dataOutputStream");
			return false;
		}
		if (len == 0)
		{
