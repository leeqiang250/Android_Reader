...
public class CmdLIST extends CmdAbstractListing implements Runnable
{
	...
	public void run()
	{
		...
		mainblock:
		{
			System.out.println("CmdLIST----start");
			String param = getParameter(input);
			System.out.println("CmdLIST----param1---	" + param);
			...
			System.out.println("CmdLIST----param2---	" + param);
			File fileToList = null;
			if (param.equals(""))
			{
				fileToList = sessionThread.getWorkingDir();
				System.out.println("CmdLIST----fileToList---	"
			...
			if (fileToList.isDirectory())
			{
				...
				System.out.println("CmdLIST----listing----" + listing);
			}
			else
			{
