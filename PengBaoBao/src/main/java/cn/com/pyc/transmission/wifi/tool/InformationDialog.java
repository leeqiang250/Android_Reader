...
public class InformationDialog extends AlertDialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((TextView) mView.findViewById(R.id.information_modified)).setText(cn.com.pyc.transmission.wifi.ui.Util
    ...
    private void onSize(final long size) {
        ...
        msg.setData(bd);
        mHandler.sendMessage(msg); // 向Handler发�?消息,更新UI
    }

    private String formatFileSizeString(long size) {
        String ret = "";
        if (size >= 1024) {
            ret = cn.com.pyc.transmission.wifi.ui.Util.convertStorage(size);
