...
import cn.com.pyc.transmission.wifi.tool.FileCategoryHelper.FileCategory;
...
public class FileIconLoader implements Callback {
    ...
    /**
     * A gate to make sure we only xml_btn_send one instance of MESSAGE_PHOTOS_NEEDED at
     * a time.
     */
        ...
        public boolean handleMessage(Message msg) {
            ...
            while (iterator.hasNext()) {
                ...
                if (holder != null && holder.state == ImageHolder.NEEDED) {
                    ...
                    switch (id.mCategory) {
                        case Apk:
                            Drawable icon = cn.com.pyc.transmission.wifi.ui.Util.getApkIcon(mContext, id.mPath);
