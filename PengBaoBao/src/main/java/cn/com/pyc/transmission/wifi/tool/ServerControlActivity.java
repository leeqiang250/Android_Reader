...
public class ServerControlActivity extends ExtraBaseActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		lvFile = (ListView) findViewById(R.id.lv_file_names);
		...
		View view = findViewById(R.id.wlan_explain);
		view.setOnClickListener(wlanExplainListener);

		ArrayList<String> pathTemp = getIntent().getStringArrayListExtra(
				GlobalIntentKeys.BUNDLE_DATA_PATHS);

		for (int i = 0; i < pathTemp.size(); i++)
		{
			String filePath = pathTemp.get(i);
			int num = filePath.lastIndexOf("/");
			String filename = filePath.substring(num + 1);
	...
	// private void wlanExplain(View view){
	// Toast.makeText(this, "WLAN使用说明", Toast.LENGTH_LONG);
	// }
	...
	private class MyAdapter extends BaseAdapter
	{
		...
		{
			TextView tv = new TextView(ServerControlActivity.this);
	...
	public void updateUi()
	{
		...
		wifiImg.setImageResource(isWifiReady ? R.drawable.imv_wifi_state1
				: R.drawable.imv_wifi_state0);
	...
	// WLAN使用说明
	OnClickListener wlanExplainListener = new OnClickListener()
	{
		@Override
		public void onClick(View v)
		{
