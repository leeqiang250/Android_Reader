...
public class PlainImageAdapter extends MediaBaseAdapter
{

	public PlainImageAdapter(Context context, ArrayList<String> paths)
	{
		super(context, paths);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (convertView == null)
		{
			convertView = mInflater.inflate(R.layout.adapter_plain_image, parent, false);
			vh = new ViewHold();
			vh.pic = (ImageView) convertView.findViewById(R.id.api_imv_image);
			vh.cbx = (CheckBox) convertView.findViewById(R.id.api_cbx_check);
