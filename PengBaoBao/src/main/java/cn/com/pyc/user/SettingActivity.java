...
public class SettingActivity extends PbbBaseActivity {
    ...
    protected void initUI() {
        UpdateTool.checkUpdateInfo(this, false); //检查更新时给apkVersion赋值
    ...
    private OnItemClickListener onItemClickListener = new OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            switch (position) {
                case 0:
                    //个人中心
                    PbbSP.getGSP(SettingActivity.this).putValue(PbbSP.SP_GUIDE_USER_FIRST_CLICK,
                            false);
//					g_imbUser.setBackgroundResource(R.drawable.xml_user);
                ...
                case 1:
                    //隐私空间
                    checkAndInpri(RollBackKey.FromMainUser);
                    break;
                case 2:
                    //PPC版
                    startActivity(new Intent(SettingActivity.this, WebActivity.class).putExtra
							(GlobalIntentKeys.BUNDLE_OBJECT_WEB_PAGE, WebActivity.WebPage.PC));
                    break;
                case 3: {
                    ...
                    if (UpdateTool.isApkNew(SettingActivity.this)) {
                        ...
                        b1.setOnClickListener(new OnClickListener() {
                            ...
                            public void onClick(View v) {
                                startActivity(new Intent(SettingActivity.this, UpdateActivity
										.class));
                                dialog.dismiss();
                            }
                        });
    ...
    private void checkAndInpri(RollBackKey fromMainUser) {
    ...
    private class SettingsAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                vh.subname = (TextView) convertView.findViewById(R.id.as_txt_subname);
            ...
            if (position == 1) {
                ...
                vh.count.setText(String.valueOf(GlobalData.getTotalCount(mContext, true)));
				/*if (GlobalData.Image.instance(mContext).changeNewNum(0) > 0 || GlobalData.Pdf.instance(mContext).changeNewNum(0) > 0 || GlobalData.Video.instance(mContext).changeNewNum(0) > 0) {
