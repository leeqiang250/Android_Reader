 ...
 */
@Deprecated
public class CodeAndReadActivity extends ExtraBaseActivity implements View.OnClickListener {
    ...
    private TextView menuText;                          //“+”菜单按钮
    ...
    private static class SmInfoPathRunnable implements Runnable {
        private WeakReference<CodeAndReadActivity> mReference;

        private SmInfoPathRunnable(CodeAndReadActivity activity) {
        ...
        public void run() {
            ...
            CodeAndReadActivity activity = mReference.get();
            //查询数据库中的smInfo；
    ...
    private static class ExecHandler extends Handler {
        private WeakReference<CodeAndReadActivity> reference;

        private ExecHandler(CodeAndReadActivity activity) {
            reference = new WeakReference<>(activity);
        }

        @Override
        public void handleMessage(Message msg) {
            CodeAndReadActivity activity = reference.get();
    ...
    public void onEventMainThread(PathsEvent event) {
        ...
        if (type == PathsEvent.P_PATH) {
            ...
            tvSendCount.setText("已加密保护 " + sendCount + "个文件");
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_code_and_read);
        initConfig();
        initView();
    }
    ...
    private void initView() {
        menuText = (TextView) findViewById(R.id.tv_menu_add);
        rlCodeView = (RelativeLayout) findViewById(R.id.rl_code_view);
        rlReadView = (RelativeLayout) findViewById(R.id.rl_readView);

        llTabCode = (LinearLayout) findViewById(R.id.ll_top_tab_code);
        llTabRead = (LinearLayout) findViewById(R.id.ll_top_tab_read);

        RelativeLayout rlSendCounts = (RelativeLayout) findViewById(R.id.rl_send_counts);//已制作发送文件数目
        LinearLayout llTakePhoto = (LinearLayout) findViewById(R.id.ll_take_photo); //拍照按钮
        LinearLayout llTakeVideo = (LinearLayout) findViewById(R.id.ll_take_video);//录像
        LinearLayout llTakeAudio = (LinearLayout) findViewById(R.id.ll_take_audio);//录音
        LinearLayout llTakeReview = (LinearLayout) findViewById(R.id.ll_take_review);//浏览
        ...
        mListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                if (source == RZListBean.Source.S_SZ) {
                    ...
                    OpenUIUtil.openFileListPage(CodeAndReadActivity.this, productInfo);
                } else if (source == RZListBean.Source.S_PBB) {
                    String filePath = bean.getFilePath();
                    Intent intent = new Intent(CodeAndReadActivity.this, PbbFileDetailActivity
                            .class);
                    ...
                    Intent intent = new Intent(CodeAndReadActivity.this, SeriesListActivity.class);
            ...
            addPopView.findViewById(cn.com.pyc.pbb.reader.R.id.xap_open_folder)
                    .setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            closePop();
                            OpenPageUtil.openActivity(CodeAndReadActivity.this, FindFileActivity
                                    .class);
                        }
                    });
            ...
            addPopView.findViewById(cn.com.pyc.pbb.reader.R.id.xap_edit).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (readerFilesAdapter != null) {
                        ...
                        showDeleteList(true);
                        deleteFilesAdapter = new DeleteFilesAdapter(CodeAndReadActivity.this,
                                mList);
...
//            llTabRead.setBackgroundResource(R.color.green_light);
    ...
    private void showDeleteMulDialog(Activity activity) {
        ...
        sure.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                selectPaths.clear();
                mSwipeLoadLayout.setRefreshing(true);
                GlobalToast.toastShort(CodeAndReadActivity.this, "删除成功");
                dialog.cancel();
            }
        });
    }
    ...
    private void Query_local_file_Verification() {
        ...
        v.findViewById(R.id.dcl_btn_goto_check).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dialog.cancel();
                startActivity(new Intent(CodeAndReadActivity.this, UserInfoActivity.class));
            }
        });
    }
