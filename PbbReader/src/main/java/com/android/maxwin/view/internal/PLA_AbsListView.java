		...
		ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnTouchModeChangeListener
{
	...
	public PLA_AbsListView(Context context)
	{
		...
		{
			initializeScrollbars(this, a, "initializeScrollbarsInternal");
		}
		else
		{
			initializeScrollbars(this, a, "initializeScrollbars");
		}
		a.recycle();
	}

	//反射调用initializeScrollbars
	private void initializeScrollbars(View view, TypedArray a, String methodStr)
	{
		Class<?> clz = android.view.View.class;
		try
		{
			Method method = clz.getDeclaredMethod(methodStr, TypedArray.class);
