...
public class PycAutoText extends AutoCompleteTextView
{
	private Drawable dRight;
	private Rect rBounds;

	public PycAutoText(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		init();
	}
	...
	protected void init()
	{
		...
		setBackgroundResource(R.drawable.xml_edt_normal);
		setThreshold(1);
