...
public class PycAutoTextGray extends AutoCompleteTextView
{
	private Drawable dRight;
	private Rect rBounds;

	public PycAutoTextGray(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		init();
	}
	...
	protected void init()
	{
		...
		setBackgroundResource(R.drawable.xml_edt_gray);
		setThreshold(1);
