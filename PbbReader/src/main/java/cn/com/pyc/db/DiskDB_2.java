 ...
 * 业务升级则委托给各个表自行管理
 */
public final class DiskDB_2
{
	private static DiskDB_2 ddb;

	public static synchronized DiskDB_2 getInstance()
	{
		if (ddb == null)
		{
			ddb = new DiskDB_2();
	...
	{
		File dirFile = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/Android/data/cn.com.pyc.pbb/db");
	...
	public static final String DB_PATH = Environment.getExternalStorageDirectory().getAbsolutePath() + "/Android/data/cn.com.pyc.pbb/db/pyc.db";
