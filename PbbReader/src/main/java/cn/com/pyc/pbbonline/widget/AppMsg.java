...
public class AppMsg {
    ...
    public static AppMsg makeText(Activity context, CharSequence text, Style style) {
        return makeText(context, text, style, R.layout.app_msg_default);
    }
    ...
    public static AppMsg makeText(Activity context, CharSequence text, Style style, float textSize) {
        return makeText(context, text, style, R.layout.app_msg_default, textSize);
    }
    ...
    public static AppMsg makeText(Activity context, CharSequence text, Style style, float textSize, OnClickListener clickListener) {
        return makeText(context, text, style, R.layout.app_msg_default, textSize, clickListener);
    }
     ...
     */
    public void show() {
        AppMsgEngine manager = AppMsgEngine.obtain(mActivity);
        manager.add(this);
    }
     ...
     */
    public void cancel() {
        AppMsgEngine.obtain(mActivity).clearMsg(this);
