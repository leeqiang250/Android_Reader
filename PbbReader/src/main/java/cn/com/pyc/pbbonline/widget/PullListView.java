...
public class PullListView extends ListView
{
	...
	// 刷新中忙碌框
	private AVLoadingIndicatorView pbHeadRefreshing;
	...
	private void changeHeaderViewByState()
	{
		switch (state)
		{
			case NONE:
				...
				ivHeadArrow.setImageResource(R.drawable.pull_list_view_arrow);
