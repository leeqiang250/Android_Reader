...
public class SlideTabHost extends RelativeLayout
{
	...
	private List<FrameLayout> mFrameLayoutList = new ArrayList<FrameLayout>();
	private List<GenerateViewListener> mGenerateViewListenerList = new ArrayList<SlideTabHost.GenerateViewListener>();
	 ...
	 * @param listener
	 */
	public void addTabAndContentGenerateListener(boolean isSelected, GenerateViewListener listener)
	{
		//update
		//		if (mTabWidget == null)
		//		{
	...
	public static interface GenerateViewListener
	{
	...
	{
		setCurrentTabIndex(newIndex, true);
	}
	...
	public interface OnTabChangedListener
	{
		 ...
		 * @param newTabIndex
		 * @param isFirstTime
		 *            是否是第一次显示tab（第一次显示tab的时候，调用生成view的方法）
		 */
