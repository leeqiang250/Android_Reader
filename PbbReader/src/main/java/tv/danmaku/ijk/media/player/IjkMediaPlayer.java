...
public final class IjkMediaPlayer extends AbstractMediaPlayer
{
			...
			throws IOException, IllegalArgumentException, SecurityException, IllegalStateException
	{
		...
		{
			setDataSource(uri.getPath(), null, 0, 0,0);
			return;
		}
	 ...
	 */
	@Override
	public void setDataSource(String path, byte[] key, long len, long offset,long fileLen)
			throws IOException, IllegalArgumentException, SecurityException, IllegalStateException
	{
		mDataSource = path;
		_SysoXXX.message("ijk  文件长度："+fileLen);
		_setDataSource(path, null, null, null, key, len,fileLen, offset);
	}

	public void setDataSource(String path, String key)
			throws IOException, IllegalArgumentException, SecurityException, IllegalStateException
	{
		mDataSource = path;

		_setDataSource(path, null, null, key, null, 0, 0,0);
	...
	private native void _setDataSource(String path, String[] keys, String[] values,
			String suizhiKey, byte[] key, long len, long offset,long fileLen)
			throws IOException, IllegalArgumentException, SecurityException, IllegalStateException;
